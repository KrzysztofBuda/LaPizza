...
void MainWindow::on_pushButton_6_clicked()
{
    ...
    if (rc != SQLITE_OK) {
        ...
        ui->textEdit->setText("Nie udało się otworzyć bazy danych");
           sqlite3_close(db);
    }
    ...
    if (rc != SQLITE_OK) {
        ...
        ui->textEdit->setText("Nie udało się utworzyć tabeli");
            sqlite3_close(db);
    }
    ...
    if (rc != SQLITE_OK) {
        ...
        ui->textEdit->setText("Nie udało się dodać rekordu");
            sqlite3_close(db);
    }

    sqlite3_close(db);
    std::cout << "Rekord został dodany do bazy danych" << std::endl;
    ui->textEdit->setText("Rekord został dodany do bazy danych");
}
